                ...
                <form id="review-form" x-show="reviewFormOpen" x-cloak method="POST"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                            ...
                            <input id="review-author" type="text" name="author_name" placeholder="Misafir"
                                   class="w-full px-3.5 py-2 rounded-lg bg-surface border border-stone-200 text-xs text-ink focus:outline-none focus:ring-1 focus:ring-terracotta focus:border-terracotta placeholder:text-muted/60">
                        </div>
                        <div>
                            ...
                            @if($hasMultipleBranches)
                                <select id="review-branch"
                                        ...
                                        class="w-full px-3.5 py-2 rounded-lg bg-surface border border-stone-200 text-xs text-ink focus:outline-none focus:ring-1 focus:ring-terracotta focus:border-terracotta">
                    ...
                    <div>
                        ...
                        <textarea id="review-comment" name="comment" rows="3"
                                  ...
                                  class="w-full px-3.5 py-2 rounded-lg bg-surface border border-stone-200 text-xs text-ink focus:outline-none focus:ring-1 focus:ring-terracotta focus:border-terracotta placeholder:text-muted/60 resize-none"></textarea>
                    </div>
