...
<div class="relative bg-surface rounded-2xl border border-warm overflow-hidden shadow-xs" 
    ...
    <div class="p-4 sm:p-5 border-b border-warm flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-sand">
        ...
        <div class="flex items-center gap-2">
            <button @click="resetView()" type="button" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-surface border border-warm text-xs font-bold text-ink hover:border-muted shadow-2xs transition-colors">
